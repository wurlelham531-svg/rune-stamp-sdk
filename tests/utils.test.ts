...
describe('isValidContractName', () => {
  it('accepts standard names', () => {
    expect(isValidContractName('rune-stamp-a1')).toBe(true);
...
describe('parseContractId / formatContractId', () => {
  it('parses valid id', () => {
    const got = parseContractId('SP16F6839630K5XX06KE7KVNSNMYBK89912NH6N4C.rune-stamp-a1');
    expect(got?.name).toBe('rune-stamp-a1');
  });
